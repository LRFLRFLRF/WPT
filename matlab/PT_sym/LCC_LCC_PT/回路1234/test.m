...
qcpp_d1_m = (a1+a1g)/2^0.5/L1^0.5-qcps_d1_m;
qcpp_d2_m = 2^0.5/L1^0.5*a1_d1-qcps_d2_m-1i*w1*qcpp_d1_m;

qcsp_m = -1i*Csp^0.5/2^0.5*(a4-a4g);
qcsp_d1_m = (a4+a4g)/2^0.5/L2^0.5-qcss_d1_m;
qcsp_d2_m = 2^0.5/L2^0.5*a4_d1-qcss_d2_m-1i*w4*qcsp_d1_m;
