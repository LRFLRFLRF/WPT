...
% eq2
eq2 = Lp*qcps_d2_m + qcps_m/Cps - qcpp_m/Cpp + M*qcss_d2_m== 0;    % M*qcss_d2_m       + RL*qcps_d1_m
...
%%%%%%%%
temp_a2_d1_res = (w2*(a2*1i + a2g*1i))/2 - ((a1 - a1g)*1i)/(2*Cpp^(1/2)*Lp^(1/2)) + ((a2 - a2g)*1i)/(2*Cps^(1/2)*Lp^(1/2)) + (M*((a3*w3*1i)/2 + (a3g*w3*1i)/2))/(Lp^(1/2)*Ls^(1/2));
